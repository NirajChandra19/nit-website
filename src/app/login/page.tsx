...
import { playfair } from "../fonts"; // Centralized font import for performance
          ...
          <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center space-x-2 cursor-pointer group">
                <input type="checkbox" className="w-4 h-4 rounded border-gray-300 dark:border-gray-600 text-blue-600 focus:ring-blue-500 dark:bg-[#050A18] cursor-pointer" />
              ...
              <Link href="#" className="text-blue-600 dark:text-blue-500 hover:text-blue-500 dark:hover:text-blue-400 font-medium transition-colors">
