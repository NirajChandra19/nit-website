    ...
    >
      ...
      <div className="grid grid-cols-2 gap-y-4 gap-x-2 mb-10 border-t border-gray-100 dark:border-gray-800/80 pt-6">
        <div className="flex items-center gap-2 text-xs font-medium text-gray-500 dark:text-gray-400">
          <FiClock className="w-4 h-4 text-blue-500 shrink-0" /> {course.duration || "10 mins"}
        </div>
        <div className="flex items-center gap-2 text-xs font-medium text-gray-500 dark:text-gray-400">
...
export default function SkillCoursesClient({ initialCourses }: { initialCourses: Course[] }) {
  ...
  }, [deferredSearchQuery, initialCourses]);
